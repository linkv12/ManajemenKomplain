...
package manajemenkomplain.pengguna.client;
 ...
 * @author link_v12
 */
public class controllerClient extends MouseAdapter implements ActionListener{
    ...
    public controllerClient(User userData,JFrame loginFr) {
    ...
    public void loadTable(){
        ...
        for (Keluhan k : keluhan) {
            if (k.getIdUser().equals(this.userData.getIdUser())) {
